...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let numBoxes = settings[kNumLettersKey] as? Int else{
                return
            }
            numItemsPerRow = numBoxes
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let numRow = settings[kNumGuessesKey] as? Int else{
                return
            }
            numRows = numRow
    // END YOUR CODE HERE
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let str_theme = settings[kWordThemeKey] as? String,
                  let grab_theme = WordTheme(rawValue:str_theme) else{
                return
            }
            
            self.goalWord = WordGenerator.generateGoalWord(with: grab_theme)
    // END YOUR CODE HERE
  }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let isAlienWordle = settings[kIsAlienWordleKey] as? Bool else {
                    return // Exit if the setting is not a Boolean
                }
